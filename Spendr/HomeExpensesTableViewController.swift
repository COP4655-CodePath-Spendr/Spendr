//
//  HomeExpensesTableViewController.swift
//  Spendr
//
...
class HomeExpensesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "HomeExpTableViewCell") as! HomeExpTableViewCell
        ...
        cell.HomeExpenseLabel.text = expense
        cell.HomeExpensesAmountLabel.text = amount!.formatted(.currency(code: "USD"))
        cell.HomeExpensesDateLabel.text = date
        cell.HomeExpensesNotesLabel.text = note
